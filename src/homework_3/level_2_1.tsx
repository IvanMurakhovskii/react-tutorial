...
type InitialAndInWorkOrderType = Extract<Order, { state: "initial" | "inWork" }> | null;
...
export const filterOnlyInitialAndInWorkOrder = (order: Order): InitialAndInWorkOrderType => {
